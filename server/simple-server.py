#!/usr/bin/env python3
"""
Simple server for Big Yellow Jacket Security
Just the essentials to get the frontend working
"""
...
async def main():
    ...
    print(f"[BYJ] Starting simple server on http://{HOST}:{PORT}")
    print(f"[BYJ] WebSocket server on ws://{HOST}:{WS_PORT}")
